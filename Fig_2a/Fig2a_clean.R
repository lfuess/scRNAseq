##This is the code that will make figure 2a for our manuscript##
##it takes the output of Loupe Browser comparing our two RBC sub-clusters
##along with the markers of B cells and Neutrophils
##and creates a heatmap of the expression of DEGs between the clusters that are also markers of Bcells or Neutrophils##
...
##first we need to get our list of significantly differentially expressed genes##
  ...
  ##filter out genes##
    ...
    ##create feature list for Seurat##

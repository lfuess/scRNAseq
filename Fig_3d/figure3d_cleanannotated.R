##this is the code we will use to create the violin plots featured in figure 3d of our manuscript##
...
clusters=read.csv("Neuts_PopInfo.csv",stringsAsFactors = FALSE)
...
populations = read.csv("Neuts_PopInfo.csv",stringsAsFactors = FALSE)
...
##And actually plot!##
##ENSGACG00000000834 (npsnA)
par(cex.lab=1.1, cex.axis=.8) 
vioplot(vcombined$ENSGACG00000000834[vcombined$Pop=="SAY"],
        vcombined$ENSGACG00000000834[vcombined$Pop=="GOS"],
        vcombined$ENSGACG00000000834[vcombined$Pop=="ROB"],
        names=c("SAY", "GOS", "ROB"),
...
##ENSGACG00000014415 (nspnB)
par(cex.lab=1.1, cex.axis=.8) 
vioplot(vcombined$ENSGACG00000014415[vcombined$Pop=="SAY"],
        vcombined$ENSGACG00000014415[vcombined$Pop=="GOS"],
        vcombined$ENSGACG00000014415[vcombined$Pop=="ROB"],
        names=c("SAY", "GOS", "ROB"),
        col=c("#46337E","#4AC16D","#FDE725"),
        rectCol="grey", colMed = 'black',
        xlab = "Cell Type",
